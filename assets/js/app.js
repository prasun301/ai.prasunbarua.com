...
function showAttachment(file) {
    ...
    if (attachmentIcon) {
        attachmentIcon.textContent = getFileIcon(file);
    }
...
async function sendMessage() {
    ...
    try {
        ...
        createAIMessage("Sorry, I couldn't process your request right now.\n\n" + error.message);
    }
...
if (chatSearch) {
    chatSearch.addEventListener("input", () => {
        ...
        historyItems.forEach((item) => {
            ...
            item.style.display = (!search || text.includes(search)) ? "block" : "none";
        });
    });
}
...
updateSendButton();
console.log("Prasun AI frontend initialized.");
